 ...
 * @author EK
 */
public final class Sunkvežimis implements KTUable<Sunkvežimis> {
    ...
    public Sunkvežimis(String markė, String modelis,
    ...
    @Override
    public int compareTo(Sunkvežimis a) {
        return getAutoRegNr().compareTo(a.getAutoRegNr());
    }

    public static Comparator<Sunkvežimis> pagalMarke = (Sunkvežimis a1, Sunkvežimis a2) -> a1.markė.compareTo(a2.markė); // pradžioje pagal markes, o po to pagal modelius

    public static Comparator<Sunkvežimis> pagalKaina = (Sunkvežimis a1, Sunkvežimis a2) -> {
    ...
    public static Comparator<Sunkvežimis> pagalMetusKainą = (Sunkvežimis a1, Sunkvežimis a2) -> {
